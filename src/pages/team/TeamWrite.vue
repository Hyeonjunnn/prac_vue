          ...
          <form @submit.prevent="submitPostData">
            <div class="grid grid-cols-1 gap-6 mt-4">
              ...
              <div>
                ...
                <textarea class="w-full mt-2 border-gray-200 rounded-md focus:border-indigo-600 focus:ring focus:ring-opacity-40 focus:ring-indigo-500" v-model="teamIntroduce"></textarea>
              </div>
