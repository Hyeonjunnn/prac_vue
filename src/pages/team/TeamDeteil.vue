    ...
    <div>
        <div class="max-w-7xl w-full mx-auto p-4 bg-white">
            ...
            <div>
                ...
                <button class="px-3 py-1 text-sm text-gray-700 bg-gray-200 rounded-md hover:bg-gray-300 focus:outline-none" @click="confirmDelete(post.no)">삭제</button>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    setup() {
        ...
        // 상세 정보 가져와서 post에 넣음
        axios.get(`http://localhost:8087/team/${teamNo}`, initParams).then((response) => {
